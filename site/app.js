(() => {
  ...
  const loadAddedPrinciples = async () => {
    await Promise.all([
      ...
      loadStylesheet('./line-composition.css?v=20260816-1', 'data-line-composition-style'),
    ...
    await Promise.all([
      ...
      loadScript('./line-composition.js?v=20260816-1', 'data-line-composition-script', '#line-composition'),
