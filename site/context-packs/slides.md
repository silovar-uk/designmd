...
使う場面:
- 3枚以上の資料で、ページ単体ではなく全体のリズムを設計する
- 固定／意味のある反復／積極的な変化を分ける
- 巨大数字、左右分割、大写真など強い手法の連続を防ぐ
- 問題→分析→解決などのフェーズ転換を見た目の変化へ対応させる

避ける場面:
- 一枚だけのスライドを作る
- 法定様式や指定テンプレートで構図変更ができない
...
- 抽出した見た目を全ページへ適用すると再びテンプレート化する失敗を見る
