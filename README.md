...
認知リズム文章ガイドは現在experimentalのため、HTML版にはまだ組み込んでいません。6文書または3案件の評価後に、公開UIへ追加するか判断します。
...
認知リズムを使う文章制作では、`DESIGN.md`に加えて次を参照します。
...
- 長文のコラム・解説を対象にした認知リズム文章ガイド
  - 対象更新／文書更新テスト
  - 問い・回収台帳
  - 認知モードと密度波形
  - 節境界、列挙の着地、結びの点検

認知リズム文章ガイドは、6文書または3案件で試行します。思わせぶりな文章の増加、結論の遅延、同型化、制作時間増、理解改善なしのいずれかが生じた場合は、縮小または撤回します。

正式採用までは、`DESIGN.md`の必須原則やHTML版へは統合しません。
...
| 日本語の長文を改善する | [`docs/writing.md`](docs/writing.md) → [`docs/cognitive-rhythm-writing.md`](docs/cognitive-rhythm-writing.md) |
...
| 日本語文章の実践編集 | [`docs/japanese-ai-writing-practices.md`](docs/japanese-ai-writing-practices.md) | stable |
| 文型・文の完結度 | [`docs/sentence-completeness.md`](docs/sentence-completeness.md) | stable |
| 認知リズム文章 | [`docs/cognitive-rhythm-writing.md`](docs/cognitive-rhythm-writing.md) | experimental |
...
日本語の長文で平坦さが問題になった場合だけ、`docs/cognitive-rhythm-writing.md`を追加で読みます。

### 外部AIへ渡す

通常は`DESIGN.md`のRaw URLだけを渡します。認知リズムはexperimentalなので、対象文書で必要な場合に限り、専用ガイドまたはプロンプトを追加します。
...
認知リズム文章ガイドは、鹿野桂一郎「cognitive-rhythm-writing」を参考に、designmd向けに編集・加工しています。原文の規則・例文をそのまま転載せず、作者による推奨・監修を意味しません。
