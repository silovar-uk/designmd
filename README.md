...
逆質問が必要な場合は、箇条書きで散らさず、ユーザーがそのまま回答を書き込める text コードブロックで提示してください。
```
...
| 目的 | 参照先 |
|---|---|
| 共通原則 | [`DESIGN.md`](DESIGN.md) |
| 段階的に制作する | [`docs/staged-production.md`](docs/staged-production.md) |
| 逆質問をテキストブロックで返す | [`docs/question-blocks.md`](docs/question-blocks.md) |
...
| 読者向け本編と制作ログを分ける | [`docs/audience-first-redesign.md`](docs/audience-first-redesign.md) |
| 学習資料を設計する | [`docs/learning-materials.md`](docs/learning-materials.md) |
| 画像・図・チャート | [`docs/visuals.md`](docs/visuals.md) |
...
- 日本語文章: [`docs/japanese-writing-review-checklist.md`](docs/japanese-writing-review-checklist.md)
- 図形・矢印・台本: [`docs/diagram-review-checklist.md`](docs/diagram-review-checklist.md)
- 読者向け成果物・学習資料: [`docs/audience-learning-review-checklist.md`](docs/audience-learning-review-checklist.md)

## プロンプト

- スライド新規作成: [`prompts/slide-create.md`](prompts/slide-create.md)
- 既存スライドの再設計: [`prompts/slide-redesign.md`](prompts/slide-redesign.md)
- 逆質問テキストブロック: [`prompts/question-block-template.md`](prompts/question-block-template.md)
- 文章レビュー: [`prompts/writing-review.md`](prompts/writing-review.md)
- あたたかみ・ユーモア: [`prompts/playful-editoriality.md`](prompts/playful-editoriality.md)
...
- 逆質問は、答えやすい入力フォームとして返します。普通の箇条書きで投げっぱなしにしません。
